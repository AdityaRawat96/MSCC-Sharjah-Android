...
public class PiousAssociationsActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new PiousAccociationsFragment(), "Pious Associations");
        adapter.addFragment(new PrayerGroupFragment(), "Prayer Groups");
        adapter.addFragment(new OtherMinistriesFragment(), "Other Ministries");
