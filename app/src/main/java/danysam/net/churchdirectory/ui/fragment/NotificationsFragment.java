...
import danysam.net.churchdirectory.adapter.NotificationsAdapter;
...
public class NotificationsFragment extends Fragment {
    ...
    private Flowable<List<danysam.net.churchdirectory.room.model.Notification>> flowableNotifications;
    ...
    private void onDataUpdated(List<danysam.net.churchdirectory.room.model.Notification> notificationList) {
        notifications.clear();
    ...
    private Collection<? extends Notification.Notification_> dbToList(List<danysam.net.churchdirectory.room.model.Notification> notificationList) {
        List<Notification.Notification_> temp = new ArrayList<>();
        for (danysam.net.churchdirectory.room.model.Notification n : notificationList) {
    ...
    private void responseToDb(List<Notification.Notification_> _notifications) {
        List<danysam.net.churchdirectory.room.model.Notification> notificationList = new ArrayList<>();

        for (Notification.Notification_ n : _notifications) {
            notificationList.add(new danysam.net.churchdirectory.room.model.Notification(Integer.parseInt(n.getId()), n.getTitle(), n.getMessage(), n.getImage(), n.getDate()));
        }
